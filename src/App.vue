      ...
      .then(incomingOrders => {
          if (incomingOrders) {
              this.orders = incomingOrders.map(newOrder => {
                  ...
                  let logDetails = { orderId: newOrder.orderId, status: newOrder.status, source: "N/A" };
                  ...
                  if (duration === 0 && existingOrder && existingOrder.duration) {
                      ...
                      logDetails.source = "Local Fallback";
                  } else if (duration > 0) {
                      logDetails.source = "API";
                  }
                  ...
                  if (duration > 0 && shippedAt) {
                      ...
                      logDetails.shippedAt = shippedAt;
                      logDetails.timePassed = timePassedMs;
                      ...
                      if (timePassedMs < totalDeliveryTimeMs) {
                          ...
                          logDetails.progress = newOrder.progressPercent.toFixed(2) + "%";
                          logDetails.timeLeft = newOrder.remainingDurationMs;
                          console.log("SHIPPING UPDATE:", logDetails);
                          ...
                          logDetails.status = "Expired/Complete";
                          console.log("SHIPPING UPDATE:", logDetails);
                        }
                      } else {
